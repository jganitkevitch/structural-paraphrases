...
parallel corpora with distributional similarity \todo{\footnotesize{What do you mean by "replacing the exact correspondence...with distributional similarity"?}}
...
employ is weaker \todo{\footnotesize{weaker than what?}}
...
outputs that break the meter.  \todo{\footnotesize{Could/should cite
    Courtney and Google's poetry generation paper if they used an
    adapted metric.}}
...
\todo{\footnotesize{I don't think you need to change this because the C\&L baseline used a 3-gram Gigaword KN lm, which in theory would be the same as the 5-gram model}}
...
compression, to achieve results outperforming \todo{\footnotesize{outperforming or competetive with?}}  state-of-the-art
