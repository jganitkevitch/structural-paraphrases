...
English side of a large bilingual corpus to procude syntactic
...
An addition focus of this paper are the closely tied topics of model
...
additional references, are crucially important factor for the system's
quality. However, this is often not reflected when estimating the
parameters of a paraphrasing system. We leverage the rich feature set
present in our approach and the flexibily of minimum error rate
...
in the past. While methods differ substantially in the nature of
the data they operate on and the approach they take to extract and
judge paraphrases, 
...
monolingual data, often coupled with additional annotations such as
dependency parses or part-of-speech tagging
