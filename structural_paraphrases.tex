...
human evaluation on Amazon Mechanical Turk, comparing it to an
implementation of the ILP-based sentence compression system introduced
by \newcite{Clarke2008}, \emph{ILP}, and the tree transducer-based
approach of \newcite{Cohn2007}, \emph{T3}.
