...
need to estimate parameters for both, paraphrase ranking and 
...
\begin{table*}
  ...
  \begin{tabular}{|c|c|}
    ...
    Reduced relative clause & $\mathit{SBAR/S}$ $\rightarrow$ in order to $\mathit{VB}$ that
    $\mid$ in order to $\mathit{VB}$ \\
    \hline
\end{tabular}
\end{center}
