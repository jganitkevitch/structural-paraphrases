...
functions $\vec{\varphi} = \{\varphi_i ... \varphi_N \}$ that are combined in a
log-linear model:
\begin{equation}
...
linguistic transformations in a more general fashion. A
phrasal system is limited to memorizing fully lexicalized
transformations in its paraphrase table, resulting in
