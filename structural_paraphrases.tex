...
informed \emph{ synchronous context-free grammar} (SCFG).  The SCFG formalism \cite{Aho1972} \mnote{cite the Aho and Ullman 1970s book Parsing, Translation and Compiling} was re-popularized for statistical machine translation by \newcite{Chiang2005}.  
...
\paragraph{Learning translation rules from bitexts}

Phrase-based approaches to statistical machine translation (and their successors) extract pairs of $(e, f)$ phrases from automatically word-aligned parallel texts. \newcite{Och2003}
...
\end{center}
\caption{An example translation produced by a syntactically-informed statistical machine translation.  Although the synchronous trees are unlike the derivations found in the Penn Treebank, their yield is a good English translation of the German input.}
