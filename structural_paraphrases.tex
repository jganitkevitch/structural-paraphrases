...
\emph{SAMT} \cite{Zollmann2006}, which is based on the \emph{weighted
  synchronous context-free grammar} (WSCFG) formalism and allows for
...
$\vec{\varphi}_2$ occurs on feature level. A significant portion of
our features are probabilities 
