...
\cite{Madnani2007}. For a candidate $C$ and a reference $R$, (with
...
term $e^{(1 - c/r)}$ is added to prevent trivially short candidates
from achieving perfect scores.

Naively optimizing for \textsc{Bleu}, however, will result in a
...
precision estimate of \textsc{Bleu} with a verbosity penalty that is
