...
source sentence more accurately.
 ...
 \begin{table}
   ...
   \caption{Results of the human evaluation on longer compressions:
     ...
     Bold indicates a statistically significance difference at $p < 0.05$. }
...
%        \hline
   ...
   \end{center}
   \normalsize
   \caption{Human evaluation for shorter compressions and for variations of our paraphrase system.  +Feat includes the compression features from Section \ref{feat-design}, +Aug includes optional deletion rules from Section \ref{injection}.  }
   \label{comparison}
 \end{table}
