...
\end{center}
\caption{TODO: write another caption}
...
is annotated with syntactic parses. Figure~\ref{example_extraction}
shows examples of rules obtained from a sentence pair. To extract a
