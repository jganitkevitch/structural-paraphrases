...
Due to the large number of extracted non-terminals, SAMT grammars tend
to be very large.

Paraphrase grammars are even larger

three thresholds

Only rules that have been seen more than $x$ times and have a
probability larger than $y$ are considered for pivot recombination. In
addition to this, we only keep the top 20 parapharses for each pattern
(according to translation and lexical probablity).
